...
public class Basic2MapFirst extends Mapper<LongWritable, Text, Text, DoubleWritable> {
    @Override
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        context.write(new Text(userId), new DoubleWritable(Double.parseDouble(movieId)));
    }
}
